...
RcppExport SEXP _KPICutils_getPIP(SEXP seedsSEXP, SEXP scansSEXP, SEXP mzsSEXP, SEXP cluSEXP, SEXP mztolSEXP, SEXP gapSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _KPICutils_waveft(SEXP omegaSEXP, SEXP scalesSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _KPICutils_cwtft(SEXP valSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _KPICutils_localMax(SEXP cwt2dSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _KPICutils_localMin(SEXP cwt2dSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type cwt2d(cwt2dSEXP);
...
RcppExport SEXP _KPICutils_ridgesDetection(SEXP cwt2dSEXP, SEXP valSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type cwt2d(cwt2dSEXP);
...
RcppExport SEXP _KPICutils_peaksPosition(SEXP valSEXP, SEXP ridgesSEXP, SEXP cwt2dSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type val(valSEXP);
...
RcppExport SEXP _KPICutils_getSignal(SEXP cwt2dSEXP, SEXP ridgesSEXP, SEXP peaksSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericMatrix >::type cwt2d(cwt2dSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_KPICutils_getPIP", (DL_FUNC) &_KPICutils_getPIP, 6},
    {"_KPICutils_waveft", (DL_FUNC) &_KPICutils_waveft, 2},
    {"_KPICutils_cwtft", (DL_FUNC) &_KPICutils_cwtft, 1},
    {"_KPICutils_localMax", (DL_FUNC) &_KPICutils_localMax, 1},
    {"_KPICutils_localMin", (DL_FUNC) &_KPICutils_localMin, 1},
    {"_KPICutils_ridgesDetection", (DL_FUNC) &_KPICutils_ridgesDetection, 2},
    {"_KPICutils_peaksPosition", (DL_FUNC) &_KPICutils_peaksPosition, 3},
    {"_KPICutils_getSignal", (DL_FUNC) &_KPICutils_getSignal, 3},
    {NULL, NULL, 0}
};

RcppExport void R_init_KPICutils(DllInfo *dll) {
